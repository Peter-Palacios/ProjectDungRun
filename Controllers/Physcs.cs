    ...
    public static class Physcs
    {
        ...
        public static char IsCollide(Entity entity, Point dir)
        {
            ...
            for (int i = 0; i < MapController.mapObjects.Count; i++)
            {
                ...
                delta.X = (entity.posX + SizeWidth / 2) - (currObject.position.X + currObject.size.Width / 2);//delta.X = (entity.posX + entity.size / 2) - (currObject.position.X + currObject.size.Width / 2);
                delta.Y = (entity.posY + SizeHeight / 2) - (currObject.position.Y + currObject.size.Height / 2);//delta.Y = (entity.posY + entity.size / 2) - (currObject.position.Y + currObject.size.Height / 2);
        ...
        //    public static bool IsCollideKey(Entity entity, Point dir)
        //    {
        //        if (entity.posX + dir.X <= 0 || entity.posX + dir.X >= MapController.cellSize * (MapController.mapWidth - 1) || entity.posY + dir.Y <= 0 || entity.posY + dir.Y >= MapController.cellSize * (MapController.mapHeight - 1))
        //        {

        //            for (int i = 0; i < MapController.mapKey.Count; i++)
        //            {
        //                var currObject = MapController.mapKey[i];
        //                PointF delta = new PointF();
